			...
			<div class="leftbody">
				<div class="nav" align="center">
					<ul>
						...
						<li><a style="color: black; background: #0489B1" href="">Flights</a></li>
				...
				<fieldset style="margin-left: 8px; margin-right: 2px">
					...
					<form id="submitform" name="form1"
						action="/context/enqueue/newflight?planName=${fn:escapeXml(planName)}&date=${fn:escapeXml(date)}"
						method="post">

						<p>
							Flight Title:<input type="text" name="activityTitle"
								style="width: 80%">
						</p>
						<p>
							Airport Address:<input id="pac-input" name="address"
						...
						<p>
							Flight Time (Please enter HH:MM  eg, 14:35): <input type="text" name="notes" />
						</p>
						<p>
							Send Reminder Email: <input type="checkbox" name="notice" />
						</p>
						<p>
