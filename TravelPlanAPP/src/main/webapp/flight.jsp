			...
			<div class="leftbody">
				...
				<fieldset style="margin-left: 8px; margin-right: 2px">				
					...
					<form
						...
						<p>
							Flight Title:<input type="text" name="activityTitle" style="width: 80%">
						</p>
						<p>
							Airport Address:<input id="pac-input" name="address" class="controls"
						...
						<p>
							Flight Time:<input type="text" name="notes" style="width: 90%">
						</p>
