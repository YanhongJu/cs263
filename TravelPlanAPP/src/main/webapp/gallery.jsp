...
<body
												...
												for (var i = 0; i < data.results.length; i++) {
													$("#list")
															.append(
																	...
																	'<div> <img u="image" style="width:800px;height=400px" src="'
	...
	<div id="slider1_container"
		style="position: relative; top: 20px; left: 250px; width: 800px; height: 500px; background: #191919; overflow: hidden;">
		...
		<!-- Slides Container -->
		<div id="list" u="slides"
			style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 400px; overflow: hidden;">
